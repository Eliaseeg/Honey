package com.beecraft.honey.api.util;
...
public class ScoreboardHelper {
    ...
    public ScoreboardHelper(String name, String criterion, String title){
        this.name = name;
    ...
    public static class Row {
        ...
        private final ScoreboardHelper scoreboard;
        private Team team;
        private final int rowInScoreboard;
        private String message;

        public Row(ScoreboardHelper sb, String message, int row){
            this.scoreboard = sb;
